...
export function FeaturedPost({ post }: FeaturedPostProps) {
  ...
  return (
    ...
    >
      <Link
        href={`/blog/${post.slug}`}
        className="group relative block overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 transition-all hover:shadow-2xl dark:border-slate-800 dark:bg-slate-900/50 dark:hover:bg-slate-900/80 md:p-12"
      >
