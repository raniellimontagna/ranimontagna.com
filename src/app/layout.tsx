...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio de Rani Montagna - Desenvolvedor Full Stack especializado em React, Next.js, Node.js e design de interfaces modernas. Criando experiências digitais excepcionais.",
  keywords:
