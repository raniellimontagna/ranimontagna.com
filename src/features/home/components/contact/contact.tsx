  ...
  return (
    <section id="contact" className="relative overflow-hidden py-20 sm:py-24 lg:py-32">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-1/4 left-0 h-150 w-150 -translate-x-1/2 rounded-full bg-[color:var(--accent-ice)]/14 blur-3xl" />
      ...
      <div className="section-shell relative z-10">
        <div className="grid gap-12 lg:grid-cols-[minmax(280px,0.8fr)_minmax(0,1.2fr)] lg:gap-16">
          <div className="lg:sticky lg:top-28 lg:h-fit">
            ...
            <FadeIn delay={0.45}>
              <div className="surface-panel-strong mt-8 overflow-hidden rounded-[1.75rem] p-6 shadow-[var(--shadow-card)]">
                ...
                <a
                  href={emailHref}
                  className="mt-4 inline-flex text-lg font-semibold tracking-[-0.04em] text-[color:var(--foreground)] transition-opacity hover:opacity-70 sm:text-xl"
                >
                  {emailLink.direct}
                </a>

                <div className="mt-6 rounded-[1.2rem] border border-[color:var(--line)] bg-[color:var(--surface)] px-4 py-4">
            ...
            <FadeIn delay={0.5}>
              <div className="mt-10">
                <div className="mb-5">
                  <h3 className="text-2xl font-semibold tracking-[-0.05em] text-[color:var(--foreground)]">
                    {t('methods.title')}
                  </h3>
                        ...
                        <StaggerItem key={method.title}>
                          <MagneticHover strength={10}>
                            <a
                              ...
                              className="group block overflow-hidden rounded-[1.5rem] border border-[color:var(--line)] bg-[color:var(--surface)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[color:var(--foreground)]/16 hover:shadow-[var(--shadow-card)]"
                            >
                              <div className="flex items-center justify-between border-b border-[color:var(--line)] bg-[color:var(--surface-strong)] px-4 py-2.5">
                                <div className="flex items-center gap-2">
                                  <span
                                ...
                                <SquareArrowRightUp className="h-3.5 w-3.5 text-[color:var(--muted)] transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                              </div>

                              <div className="flex items-center gap-4 p-4">
                                <div
                                  className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-[1rem] border border-[color:var(--line)] transition-all duration-300 ${
                                    method.color === 'green'
                                      ? 'bg-emerald-500/12 text-emerald-700 dark:text-emerald-300'
                                      : 'bg-sky-500/12 text-sky-700 dark:text-sky-300'
                                  }`}
                                ...
                                <span className="hidden rounded-full border border-[color:var(--line)] bg-[color:var(--surface-strong)] px-3 py-1.5 text-xs font-semibold text-[color:var(--foreground)] sm:inline-flex">
                                  {method.action}
                                </span>
                              </div>
                            </a>
          ...
          <FadeIn delay={0.6} direction="right">
            <ParallaxLayer offset={26}>
              <div className="surface-panel-strong relative overflow-hidden rounded-[2rem] shadow-[var(--shadow-card)]">
                ...
                <div className="relative flex items-center gap-2 border-b border-[color:var(--line)] bg-[color:var(--surface-strong)] px-5 py-4">
                  <div className="flex gap-1.5">
                    <div className="h-3 w-3 rounded-full bg-red-500" />
                    <div className="h-3 w-3 rounded-full bg-yellow-500" />
                    <div className="h-3 w-3 rounded-full bg-green-500" />
                  </div>
                  <div className="ml-2 flex items-center gap-2 text-xs text-[color:var(--muted)]">
                ...
                <div className="relative p-6 sm:p-8 lg:p-10">
                  <div className="mb-8 grid gap-4 rounded-[1.4rem] border border-[color:var(--line)] bg-[color:var(--surface)] p-5 sm:grid-cols-[1fr_auto] sm:items-end">
                    ...
                    <div className="rounded-full border border-[color:var(--line)] bg-[color:var(--surface-strong)] px-4 py-2 font-mono text-[11px] uppercase tracking-[0.22em] text-[color:var(--muted)]">
                      {t('status.response')}
                    </div>
                  </div>
